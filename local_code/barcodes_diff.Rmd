...
pegasus.mad.dir <- "/Users/michaelalperovich/Documents/primes_storage/output_pg/mc_tm/Kidney/1.4-mad-2/"
pegasus.cutoff.dir <- "/Users/michaelalperovich/Documents/primes_storage/output_pg/mc_tm/Kidney/1.4-cutoff-10/"
pegasus.dir <- "/Users/michaelalperovich/Documents/primes_storage/output_pg/mc_tm/Kidney/1.4-none-0/"
```
...
```{r}
write.csv(merge.filtered.dfs(pegasus.all.cells, pegasus.clusters, pegasus.cutoff.filtered, pegasus.mad.filtered, pegasus.cutoff.counts, pegasus.cutoff.genes, pegasus.cutoff.mito, pegasus.cutoff.ribo), "pg_cutoff.csv")
write.csv(merge.filtered.dfs(pegasus.all.cells, pegasus.clusters, pegasus.mad.filtered, pegasus.cutoff.filtered, pegasus.mad.counts, pegasus.mad.genes, pegasus.mad.mito, pegasus.mad.ribo), "pg_mad.csv")
```
