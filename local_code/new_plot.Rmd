...
summ <- summ %>% arrange(desc(mean.percent.mt))
...
ggsave(filename = "plot1.png", plot = plot + err + t, width = 30, height = 10)
ggsave(filename = "plot2.png", plot = plot + t, width = 30, height = 10)
```
...
summ=summ%>%left_join(tissue.max, by="tissue")
summ <- summ %>% arrange(desc(median.percent.mt))
...
t <- theme(axis.text.x = element_text(angle = 45, size=10, hjust=1, face="bold"), axis.text.y = element_text(size=10), axis.title.x=element_blank())
ggsave(filename = "plot3.png", plot = plot + err + t, width = 30, height = 10)
ggsave(filename = "plot4.png", plot = plot + t, width = 30, height = 10)
```
...
summ=summ%>%left_join(tissue.max, by="tissue")
summ <- summ %>% arrange(desc(mean.nFeature_RNA))
...
t <- theme(axis.text.x = element_text(angle = 45, size=10, hjust=1, face="bold"), axis.text.y = element_text(size=10), axis.title.x=element_blank())
ggsave(filename = "plot5.png", plot = plot + err + t, width = 30, height = 10)
ggsave(filename = "plot6.png", plot = plot + t, width = 30, height = 10)
```
...
summ=summ%>%left_join(tissue.max, by="tissue")
summ <- summ %>% arrange(desc(median.nFeature_RNA))
...
t <- theme(axis.text.x = element_text(angle = 45, size=10, hjust=1, face="bold"), axis.text.y = element_text(size=10), axis.title.x=element_blank())
ggsave(filename = "plot7.png", plot = plot + err + t, width = 30, height = 10)
ggsave(filename = "plot8.png", plot = plot + t, width = 30, height = 10)
```
