...
for (project in dir(results.dir,  pattern="mc_", recursive=FALSE)) {
  for (tissue in dir(paste0(results.dir, project, "/"), recursive=FALSE)) {
    ...
    mad.dir <- paste0(tissue.dir, "1.4-mad-2/")
    cutoff.dir <- paste0(tissue.dir, "1.4-cutoff-10/")
    ...
    for (cl in rownames(mad.clusters)) {
      cluster.cells <- as.character(subset(mad.cells, louvain_labels == cl)$X)
      ribo.mean <- mean(subset(mad.cells, louvain_labels == cl)$percent_ribo)
